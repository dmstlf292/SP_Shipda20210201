											...
											<div id="col1" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="title1">
												<div class="panel-body">
													<div class="col-md-6">
														<p>
															<label>출발지 국가</label>
															<input type="text" class="form-control"  name="departure" value="<%=fbean.getDeparture()%>" readonly>
														</p>
														<p>
															<label>출발 port</label>
															<input type="text"  class="form-control" name="port" value="<%=fbean.getPort()%>" readonly>
														</p>
														<p>
															<label>출발지 내륙 상세주소 입력</label>
															<input type="text"  class="form-control" name="address" value="<%=fbean.getAddress()%>" readonly>
														</p>
														<p>
															<label>출발지 경유지 항구</label>
															<input type="text"class="form-control"  name="transit" value="<%=fbean.getTransit()%>" readonly>
														</p>
													</div>	
													<div class="col-md-6">
														<p>
															<label>도착지 국가</label>
															<input type="text" class="form-control" name="arrive" value="<%=fbean.getArrive()%>" readonly>
														</p>
														<p>
															<label>도착 port</label>
															<input type="text"  class="form-control" name="aport" value="<%=fbean.getAport()%>" readonly>
														</p>
														<p>
															<label>도착지 내륙 상세주소 입력</label>
															<input type="text"  class="form-control"  name="aAddress" <%=fbean.getaAddress()%>" readonly>
														</p>
														<p>
															<label>도착지 경유지 항구</label>
															<input type="text"class="form-control" name="aTransit" <%=fbean.getaTransit()%>" readonly>
														</p>
													</div>
												</div>
											</div>
											...
											<div id="col3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="title3">
												<div class="panel-body">
													<div class="col-md-4">
														<p>
															<label>LSS</label>
															<input type="text"  class="form-control"name="lss" value="<%=fbean.getLss()%>" readonly>
														</p>
													</div>
													<div class="col-md-4">
														<p>
															<label>Ocean Surcharge</label>
															<input type="text"  class="form-control"name="surcharge" value="<%=fbean.getSurcharge()%>" readonly>
														</p>
													</div>
													<div class="col-md-4">
														<p>
															<label>국내 부대비용</label>
															<input type="text"  class="form-control"name="extra" value="<%=fbean.getExtra()%>" readonly>
														</p>
													</div>
												</div>
